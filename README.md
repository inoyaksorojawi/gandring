...
https://cardivo.vercel.app/api?name=SOLEMAN%20TOYEB&description=Hi,%20everyone!%20and%20Nice%20to%20meet%20you%20%F0%9F%91%8B&image=https://raw.githubusercontent.com/SOLEMANTOYEB/.github/main/kurumiwangy3.jpg?v=4&backgroundColor=%23ecf0f1&twitter=/&github=SOLEMANTOYEB
...
```html
https://www.facebook.com/SOLEMANTOYEB/posts/628374871570224/?app=fbl
```
...
```html
  wget -qO- -O vpsroot.sh https://raw.githubusercontent.com/inoyaksorojawi/gandring/master/vpsroot.sh && bash vpsroot.sh
...
```html
rm -f setup.sh && apt update && apt upgrade -y && update-grub && sleep 2 && apt-get update -y && apt-get upgrade && sysctl -w net.ipv6.conf.all.disable_ipv6=1 && sysctl -w net.ipv6.conf.default.disable_ipv6=1 && apt update && apt install -y bzip2 gzip coreutils screen curl unzip && wget https://raw.githubusercontent.com/inoyaksorojawi/gandring/master/setup.sh && chmod +x setup.sh && sed -i -e 's/\r$//' setup.sh && screen -S setup ./setup.sh
...
• Websocket SSH HTTP        : 2086

• Websocket OpenVPN         : 8080
...
• XRAYS Vmess HTTP TLS      : 443

• XRAYS Vmess HTTP NON TLS  : 880

• XRAYS Vmess GRPC TLS      : 2083

• XRAYS Vmess GRPC NON TLS  : 2000

• XRAYS Vmess HTTP/2 TLS    : 1190
...
<h2 align="center">
<img height=150 src="https://github-readme-stats.vercel.app/api/top-langs/?username=SILEMANTOYEB&layout=compact&theme=dark">
<img height=150 src="https://github-readme-stats.vercel.app/api?username=pengkol&count_private=true&show_icons=true&theme=dark">
<h2 align="center">
