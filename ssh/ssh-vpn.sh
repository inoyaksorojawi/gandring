...
DAEMON_OPTS="--user sslh --listen 0.0.0.0:2087 --ssl 127.0.0.1:500 --ssh 127.0.0.1:300 --ssh 127.0.0.1:2242 --openvpn 127.0.0.1:700 --openvpn 127.0.0.1:900 --http 127.0.0.1:2086 --pidfile /var/run/sslh/sslh.pid -n"
