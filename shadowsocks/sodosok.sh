#!/bin/bash
#shadowsocks-libev obfs install by wisnu
# ==========================================
# Color
RED='\033[0;31m'
NC='\033[0m'
...
iptables -I INPUT -m state --state NEW -m tcp -p tcp --dport 20000-20500 -j ACCEPT
iptables -I INPUT -m state --state NEW -m udp -p udp --dport 20501-21000 -j ACCEPT
